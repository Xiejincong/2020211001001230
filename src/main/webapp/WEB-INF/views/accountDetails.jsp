						...
						<c:otherwise>
							...
							<c:forEach  var="o" items="${orderList}">
								<tr>
									...
									<td class="cart_total">
										<%
											com.zengzhaogui.model.Order o=(com.zengzhaogui.model.Order)pageContext.findAttribute("o");
											int n=o.getPaymentId();
											java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
											String paymentType=com.zengzhaogui.model.Payment.findByPaymentId(con,n);
										%>
